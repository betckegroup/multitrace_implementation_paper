...
def halves(domain=1, r1=1, r2=1, r3=1, origin=(0, 0, 0), h=0.1):
    """
    ...
    if domain==1:
        ...
        Physical Surface(10) = {14,16,24,20, 101};
        Mesh.Algorithm = 6;
        """
    elif domain ==2:
        stub2 = """
        ...
        Line Loop(100) = {5,6,7,8};
        Ruled Surface(101) = {100};
        Physical Surface(20) = {18,22,26,28,101};
        Mesh.Algorithm = 6;
        """
    geometry = (
        "r1 = "
...
def half2(r1=1, r2=1, r3=1, origin=(0, 0, 0), h=0.1):
    """
    Return an ellipsoid grid.
